    ...
    <body class="mod-bg-1 mod-nav-link ">
        <main id="js-page-content" role="main" class="page-content">
            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="<?php echo $user['id'];?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $user['tag'];?>">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?php echo str_replace([' ', '(', ')', '-'], '', $user['phone']); ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
