<?php include 'task_18_images.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                                ...
                                <?php if (!empty($images)): ?>
                                    <?php foreach ($images as $image): ?>
                                        <div class="col-md-3 image">
                                            <img src="upload/<?php echo $image['src'] ?>">
                                            <a class="btn btn-danger" href="task_18_delete_image.php?id=<?php echo $image['id']?>" onclick="confirm('Вы уверены?');">Удалить</a>
                                        </div>
                                    <?php endforeach ?>
                                <?php endif ?>
                            </div>
