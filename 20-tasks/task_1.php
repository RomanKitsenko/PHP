                    ...
                    <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                        ...
                        $articles = [
                            ...
                            2 => [
                                ...
                                'text' => "
                                                Описание для статьи, чтобы рассказать о чем будет в статье в кратце. Здесь абсолютно комфортно вы можете
                                                генерировать тексты-«рыбы» для решения задач в области макетирования.
                                                <br><br>
                                                Мы будем постепенно расширять функциональность нашего сайта и ждем с нетерпением ваших отзывов.Присылайте нам
                                                ваши рыбные тексты! Мы будем рады!
                                            "
                            ]
